...
export default function Register() {
  ...
  // Name Prompt state for Google login
        ...
        >
          <div className="auth-branding-inner">
            ...
            <div className="auth-branding-stats">
              <div><span>🎮</span><p>Gaming Gear</p></div>
              <div><span>🖥️</span><p>Custom PC</p></div>
              <div><span>🚀</span><p>Ship Tốc Độ</p></div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="auth-form-inner">
            <div className="auth-form-header">
              ...
              <h1 className="auth-form-title glitch-text" data-text="ĐĂNG KÝ">ĐĂNG KÝ</h1>
            ...
            {success && (
              <motion.div className="auth-success" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
                {success}
              </motion.div>
            )}
             ...
             {!showNamePrompt && (
               <>
                 ...
                 <div className="auth-social">
                   ...
                   <button type="button" className="auth-social-btn facebook" onClick={() => window.toast.info('Facebook OAuth - Coming Soon')}>
            ...
            <p className="auth-switch">
              Đã có tài khoản?{' '}
              <Link to="/login" className="auth-switch-link">Đăng nhập <ArrowRight size={14} /></Link>
            </p>
          </div>
        </motion.div>
      </div>
