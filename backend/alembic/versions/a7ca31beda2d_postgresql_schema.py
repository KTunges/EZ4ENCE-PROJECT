...
Revision ID: a7ca31beda2d
Revises: 
Create Date: 2026-06-09 00:53:04.198144
...
def upgrade() -> None:
    ...
    sa.Column('payment_method', sa.Enum('COD', 'PAYPAL', 'VNPAY', name='paymentmethod'), nullable=False),
